...
@mapdef Entity "MaxHelpingHand/SetFlagOnButtonPressController" SetFlagOnButtonPressController(x::Integer, y::Integer, button::String="Grab", flag::String="flag_name", inverted::Bool=false)
