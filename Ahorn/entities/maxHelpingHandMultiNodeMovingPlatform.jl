...
@pardef MultiNodeMovingPlatform(x::Integer, y::Integer, width::Integer=Maple.defaultBlockWidth, mode::String="Loop", texture::String="default",
    ...
    emitSound::Bool=true, giveHorizontalBoost::Bool=false, drawTracks::Bool=true) =
    ...
    emitSound=emitSound, giveHorizontalBoost=giveHorizontalBoost, drawTracks=drawTracks)
