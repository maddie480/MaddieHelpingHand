...
@mapdef Entity "MaxHelpingHand/MoreCustomNPC" MoreCustomNPC(x::Integer, y::Integer, sprite::String="player/idle", spriteRate::Int=1, dialogId::String="", onlyOnce::Bool=true, endLevel::Bool=false,
    ...
    frames::String="", onlyIfFlag::String="", setFlag::String="", onlyIfFlagInverted::Bool=false, setFlagInverted::Bool=false, autoSkipEnabled::Bool=false,
...
@mapdef Entity "MaxHelpingHand/CustomNPCSprite" CustomNPCSprite(x::Integer, y::Integer, dialogId::String="", onlyOnce::Bool=true, endLevel::Bool=false,
    ...
    spriteName::String="bird", onlyIfFlag::String="", setFlag::String="", onlyIfFlagInverted::Bool=false, setFlagInverted::Bool=false, autoSkipEnabled::Bool=false,
    nodes::Array{Tuple{Integer, Integer}, 1}=Tuple{Integer, Integer}[])
