...
@mapdef Entity "MaxHelpingHand/GroupedTriggerSpikesUp" GroupedTriggerSpikesUp(x::Integer, y::Integer, width::Integer=Maple.defaultSpikeWidth, type::String="default", behindMoveBlocks::Bool=false, triggerIfSameDirection::Bool=false, killIfSameDirection::Bool=false)
@mapdef Entity "MaxHelpingHand/GroupedTriggerSpikesDown" GroupedTriggerSpikesDown(x::Integer, y::Integer, width::Integer=Maple.defaultSpikeWidth, type::String="default", behindMoveBlocks::Bool=false, triggerIfSameDirection::Bool=false, killIfSameDirection::Bool=false)
@mapdef Entity "MaxHelpingHand/GroupedTriggerSpikesLeft" GroupedTriggerSpikesLeft(x::Integer, y::Integer, height::Integer=Maple.defaultSpikeHeight, type::String="default", behindMoveBlocks::Bool=false, triggerIfSameDirection::Bool=false, killIfSameDirection::Bool=false)
@mapdef Entity "MaxHelpingHand/GroupedTriggerSpikesRight" GroupedTriggerSpikesRight(x::Integer, y::Integer, height::Integer=Maple.defaultSpikeHeight, type::String="default", behindMoveBlocks::Bool=false, triggerIfSameDirection::Bool=false, killIfSameDirection::Bool=false)
...
groupedTriggerSpikesArrows = Dict{String, String}(
    "up" => "↑",
    "down" => "↓",
    "left" => "←",
    "right" => "→"
